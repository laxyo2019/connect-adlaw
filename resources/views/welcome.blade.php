...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Laxyo</a>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          @guest
            <h1 class="text-uppercase text-white font-weight-bold">We've been expecting you.</h1>
          @else
            <h1 class="text-uppercase text-white font-weight-bold">Hello, {{ auth()->user()->name }}</h1>
          @endguest  
          <hr class="divider my-4">
        </div>
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">Welcome to Laxyo Group! We're ISO 9001:2015 and ISO 18001:2007 OHSAH Certified Company. An amalgamation of firms and organizations.</p>
          @guest
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="{{ route('login') }}">Login</a>
          @else
            <a class="btn btn-success btn-xl js-scroll-trigger" href="{{ route('home') }}">Home</a>
          @endguest  
        </div>
      </div>
    </div>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Copyright &copy; 2019 - Laxyo</div>
    </div>
  </footer>
